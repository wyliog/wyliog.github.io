...
**[在这里预览模板 &rarr;](http://willants.com/huxblog-boilerplate/)**
...
看右边:
![](http://willants.com/img/blog-sidebar.jpg)
...
![](http://willants.com/img/blog-keynote.jpg)
...
---
layout:     keynote
iframe:     "http://willants.com/js-module-7day/"
---
```
...
ga_domain: willants.com			# 默认的是 auto, 这里我是自定义了的域名，你如果没有自己的域名，需要改成auto。
```
